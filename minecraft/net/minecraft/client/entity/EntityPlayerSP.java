...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void updateEntityActionState()
    {
        ...
        if (this.isCurrentViewEntity())
        {
            ...
            this.field_191988_bg = this.movementInput.moveFoward;
    ...
    public void onLivingUpdate()
    {
        ...
        float f = 0.8F;
        boolean flag2 = this.movementInput.moveFoward >= 0.8F;
        ...
        if (this.isHandActive() && !this.isRiding())
        {
            ...
            this.movementInput.moveFoward *= 0.2F;
        ...
        if (this.onGround && !flag1 && !flag2 && this.movementInput.moveFoward >= 0.8F && !this.isSprinting() && flag4 && !this.isHandActive() && !this.isPotionActive(MobEffects.BLINDNESS))
        {
        ...
        if (!this.isSprinting() && this.movementInput.moveFoward >= 0.8F && flag4 && !this.isHandActive() && !this.isPotionActive(MobEffects.BLINDNESS) && this.mc.gameSettings.keyBindSprint.isKeyDown())
        {
            this.setSprinting(true);
        }

        if (this.isSprinting() && (this.movementInput.moveFoward < 0.8F || this.isCollidedHorizontally || !flag4))
        {
        ...
        if (this.capabilities.isFlying && this.isCurrentViewEntity())
        {
            if (this.movementInput.sneak)
            {
                ...
                this.movementInput.moveFoward = (float)((double)this.movementInput.moveFoward / 0.3D);
